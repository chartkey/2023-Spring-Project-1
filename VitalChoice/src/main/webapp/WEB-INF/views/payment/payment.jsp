    ...
    <table border="1" align="center">
        ...
        <c:forEach items="${splist}" var="splist">
            <tr>
                ...
                <td style="padding: 3px;"><img src="thumb_img/${splist.productNum}_1" style="height: 50px; width:50px; padding: 0; margin: 0;"></td>
    ...
    <table border="1" align="center" id="deliveryInfoTable">
        ...
        <tr>
            ...
            <td>
				...
				<br>
				<input type="text" id="deliveryaddress2" name="deliveryaddress2" value="${payerdto.user_address2}" readonly="readonly"  style="width: 100%;">
				<input type="text" id="deliveryaddress3" name="deliveryaddress3" value="${payerdto.user_address3}" placeholder="상세 주소를 입력해주세요." style="width: 100%;">
        ...
        <tr>
            <th>배송요청사항</th>
            <td><input type="text" id="deliveryrequest" name="deliveryrequest" value="정성을 다해 배송하겠습니다." style="width: 100%;"></td>
        </tr>
    </table>
    <h4>결제정보</h4>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            function handleAllIn() {
                if ($("#allin").is(":checked")) {
                    var userPoint = Number($("#point").attr("maxVal"));
                    $("#point").val(userPoint);
                } else {
                    $("#point").val("");
                }
