...
public class PayerDTO {
	...
	user_email,user_birthday,user_gender,user_nickname,user_insertdate;
	int email_check,user_role,user_grade,user_totpurchase,user_point;
	public PayerDTO() {
	}
	public PayerDTO(String user_id, String user_name, String user_phone, String user_address1, String user_address2,
			String user_address3, String user_email, String user_birthday, String user_gender, String user_nickname,
			String user_insertdate, int email_check, int user_role, int user_grade, int user_totpurchase,
			int user_point) {
		super();
